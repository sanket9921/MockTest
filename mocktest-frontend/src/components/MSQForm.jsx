...
const MCQForm = ({
  ...
  const [correctAnswers, setCorrectAnswers] = useState([]); // ✅ Now an array for MSQ
  ...
  const handleSubmit = async () => {
    ...
    formData.append("question_type", "multiple_choice"); // ✅ Different from MCQ
      ...
      {options.map((option, index) => (
        <div key={index}>
          <OptionInput
            ...
            type="checkbox" // ✅ MSQ uses checkboxes for multiple correct answers
